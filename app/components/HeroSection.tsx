				...
				<div className="text-center space-y-6">
					...
					<div className="space-y-4 sm:space-y-6 mt-6 sm:mt-8">
						...
						<div className="flex flex-wrap justify-center gap-2 sm:gap-3 mt-6 sm:mt-8 px-4 sm:px-0">
							{['MicroService', 'Docker', 'Kubernetes', 'Apache Kafka', 'Laravel', 'Spring Boot', 'MySQL', 'PostgreSQL', 'MongoDB', 'Redis', 'Jenkins', 'gRPC', 'Rest API', 'Circuit Breaker', 'Cloud Computing', 'Linux'].map((tech) => (
								<span
									key={tech}
